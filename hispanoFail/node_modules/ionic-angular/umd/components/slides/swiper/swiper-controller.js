(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", './swiper', './swiper-index', './swiper-utils', './swiper-progress', './swiper-transition'], factory);
    }
    ...
    exports.SWIPER_CONTROLLER = {
        ...
        setTranslate: function (s, plt, translate, byController) {
            ...
            function setControlledTranslate(c) {
                ...
                swiper_transition_1.setWrapperTranslate(c, plt, controlledTranslate, false, s);
        ...
        setTransition: function (s, plt, duration, byController) {
            var controlled = s.control;
            var i;
            function setControlledTransition(c) {
                swiper_transition_1.setWrapperTransition(c, plt, duration, s);
                if (duration !== 0) {

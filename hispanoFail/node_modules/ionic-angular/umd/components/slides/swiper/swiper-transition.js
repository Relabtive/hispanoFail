(function (factory) {
    ...
    function setWrapperTranslate(s, plt, translate, shouldUpdateActiveIndex, byController) {
        ...
        if (s.control) {
            swiper_controller_1.SWIPER_CONTROLLER.setTranslate(s, plt, s._translate, byController);
        }
    }
    ...
    function setWrapperTransition(s, plt, duration, byController) {
        ...
        if (s.control) {
            swiper_controller_1.SWIPER_CONTROLLER.setTransition(s, plt, duration, byController);
        }
    }
